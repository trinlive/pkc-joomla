...
if (class_exists('\Joomla\CMS\Form\Field\TextField')) {
	class JFormFieldMediaboxcktextBase extends \Joomla\CMS\Form\Field\TextField {}
} else {
	class JFormFieldMediaboxcktextBase extends JFormFieldText {}	
}

class JFormFieldMediaboxcktext extends JFormFieldMediaboxcktextBase {
