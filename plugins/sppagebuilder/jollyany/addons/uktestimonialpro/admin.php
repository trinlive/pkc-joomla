...
SpAddonsConfig::addonConfig(
	array(
		'type'=>'repeatable',
		'addon_name'=>'uktestimonialpro',
		'title'=>JText::_('UK Testimonial Pro'),
		'desc'=>JText::_('Testimonial Pro with UI Kit'),
        'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uktestimonialpro/assets/images/icon.png',
		'category'=>'Jollyany',
		'attr'=>array(
			'general' => array(
