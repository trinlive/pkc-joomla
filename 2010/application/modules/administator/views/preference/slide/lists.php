...
$(document).ready(function(e) {
 ...
 <div class="row">
     <div class="col-md-12">
         ...
         <div style="float: right;padding-bottom:10px"><a href="<?php echo site_url(admin_module('preference/slide/new'))?>" class="btn btn-primary" >เพิ่มรูปสำหรับสไลด์ ใหม่ <i class="fa fa-arrow-circle-right"></i></a></div>
         ...
         <div class="panel panel-default">
             ...
             <div class="panel-body">
                 <table class="table table-hover" id="sample-table-1">
                  ...
                  <?php
                    $i = 0;
                    if(isset($slidelist['rows'])):
                        foreach($slidelist['rows'] as $rows):
                            $i++;
                    ?>
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><a href="<?php echo site_assets_url('images/slide/'.$rows['image']);?>" target="_blank"><?php echo $rows['title']; ?></a> (<font color="red"><?php echo $rows['name'];?></font>)</td>
                      ...
                      <td><?php echo ($rows['lastupdate'] == '')? 'สร้าง :<font color="#0075EA">'.format_date1($rows['datepost']).'</font>':'สร้าง  : <font color="#0075EA">'.format_date1($rows['datepost']).'</font><br>แก้ไข : <font color="#E13800">'.format_date1($rows['lastupdate']).'</font>'; ?></td>
                        ...
                        <td class="center">
                            <div class="visible-md visible-lg hidden-sm hidden-xs">
                                <a href="<?php echo site_url(admin_module('preference/slide/edit?slide_id='.$rows['id']))?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="แก้ไข"><i class="fa fa-edit"></i></a>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul role="menu" class="dropdown-menu pull-right">
                                        <li role="presentation">
                                            <a role="menuitem" tabindex="-1" href="<?php echo site_url(admin_module('preference/slide/edit?slide_id='.$rows['id']))?>">
