...
<div class="box_news_main_news">
    <div class="main_content_green_long"><?php echo 'ข่าวประกวดราคา';?></div>
    <div class="clearfix"></div>
    <?php if(isset($auction['rows'])):?>
        <?php foreach($auction['rows'] as $rows):?>
            <a href="<?php echo site_assets_url('images/auction/'.$path.'/'.$rows['link']);?>" target="_blank">
                <div class="buy_box ">
