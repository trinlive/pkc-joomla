...
// print_r($_GET);
 	$keysearch = $_GET['keysearch'];
  	$title_book = $_GET['title_book'];
   	$ower_book = $_GET['ower_book'];
 
$SQLstr_book =  " SELECT * FROM `book_libraries` WHERE `book_status` = 'Active' 
AND cate_book='$keysearch'
AND book_name Like'%".$title_book."%' 
AND book_ower Like'%".$ower_book."%'
...
$GenericEasyPagination->getsVars = "keysearch=$keysearch&book_name=$book_name&book_ower$book_ower" ;
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="NewsContent">
                        <tr>
                          <td width="128" valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="border_gray">
                              <tr>
                                <td align="center" width="120" height="159" style="background:url(images/bg_defaults.jpg) top center no-repeat"><?php 
                  ...
                  <tr>
                    <td height="10"></td>
                               ...
                               <?php $rs_book->MoveNext(); $i++; ?>
                                <?php endwhile; ?>    
                              <?php elseif($rs_book->EOF): ?> 
                        
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>&nbsp;svssgsdfgdsfsd</td>
  </tr>
</table>
