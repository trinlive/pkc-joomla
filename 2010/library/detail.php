...
$SQLstr_book =  " SELECT * FROM `book_libraries` WHERE `book_status` = 'Active' AND book_id='$book_id' ORDER BY `book_id` desc";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <td style="position:relative"> </td>
            ...
            <tr>
              ...
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="80" valign="bottom" class="TxtGreen11B01"><!--smarty $postdate|date_format:"%d.%m.%y" --></td>
                    <td class="TxtBlue12B01"><!--smarty $topic|stripslashes --></td>
                    <td width="5"></td>
                  </tr>
                </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td width="280">
                       <?php 
								...
								?>
                                <a href="detail.php?book_id=<?php echo $rs_book->fields['book_id'] ?>"><img src="img_book/thumbnail/<?php echo $rs_book->fields['book_images'] ?>" width="280"  border="0" /></a>
                                <?php
                                }else{
								?>
                                
                                <img src="img_book/thumbnail/default_image.jpg" width="280">                                <?php
                                }
								?>           
                      ...
                      <table width="348" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td width="81" class="txtBlue11N02">ลำดับเอกสาร&nbsp;:&nbsp; </td>
                                <td class="txtOrange11N02"><?php echo $rs_book->fields['book_number'] ?></td>
                              ...
                              <tr>
                               ...
                               <tr>
                                <td width="81" class="txtBlue11N02">ปีที่เก็บเอกสาร&nbsp;:&nbsp; </td>
                                <td class="txtOrange11N02"><?php echo $rs_book->fields['book_year'] ?></td>
                                <td class="TxtGreen11B01">&nbsp;</td>
                              </tr>
                              <tr>
                                <td height="9"></td>
                              ...
                              <tr>
                                <td class="txtBlue11N02">ชื่อเรื่อง&nbsp;:&nbsp;</td>
                                <td class="txtBlue12B03-1"><?php echo $rs_book->fields['book_name'] ?></td>
                                <td>&nbsp;</td>
                              </tr>
                              <tr>
                                <td height="9"></td>
                             ...
                             <tr>
                                <td class="txtBlue11N02">ชนิดเอกสาร&nbsp;:&nbsp;</td>
                                <td><div align="justify" class="txtOrange11N02"><?php
	...
	?></div></td>
                              ...
                              <tr>
                                <td class="txtBlue11N02">เจ้าของเรื่อง&nbsp;:&nbsp;</td>
                                <td><div align="justify" class="txtOrange11N02"><?php echo $rs_book->fields['book_ower'] ?></div></td>
                                <td>&nbsp;</td>
                              </tr>
                              <tr>
                                <td height="9"></td>
                               ...
                               <tr>
                                <td class="txtBlue11N02">จำนวนเอกสาร&nbsp;:&nbsp;</td>
                                <td><div align="justify" class="txtOrange11N02"><?php echo $rs_book->fields['book_num'] ?></div></td>
                                <td>&nbsp;</td>
                              </tr>
                              <tr>
                                <td height="9"></td>
                              ...
                              <tr>
                                <td class="txtBlue11N02">สถานะเอกสาร&nbsp;:&nbsp;</td>
	...
	?></div></td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><a href="javascript:history.back()" class="TxtBlue12B01">ย้อนกลับ</a></td>
                    </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
