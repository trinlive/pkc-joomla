<?php /* Smarty version 2.6.18, created on 2010-09-26 17:20:41
         compiled from tips.tpl.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'tips.tpl.htm', 212, false),array('modifier', 'substring', 'tips.tpl.htm', 212, false),array('modifier', 'date_format', 'tips.tpl.htm', 228, false),)), $this); ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="990" valign="top"><?php include("inc_menu_top_tips.php");?>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','317','height','99','src','flash/toppic_tips','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','flash/toppic_tips' ); //end AC code
                    ...
                    <param name="movie" value="flash/toppic_tips.swf" />
                    <param name="quality" value="high" />
                    <param name="wmode" value="transparent" />
                    <embed src="flash/toppic_tips.swf" width="317" height="99" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="transparent"></embed>
                  </object>
</noscript></td>
                  <td>&nbsp;</td>
                </tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','282','height','53','src','flash/topic_tips2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','flash/topic_tips2' ); //end AC code
                      ...
                      <param name="movie" value="flash/topic_tips2.swf" />
                      <param name="quality" value="high" />
                      <param name="wmode" value="transparent" />
                      <embed src="flash/topic_tips2.swf" width="282" height="53" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="transparent"></embed>
                    </object>
</noscript></td>
                    <td width="24">&nbsp;</td>
                  </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr valign="top">
              <td width="57">&nbsp;</td>
              <td><?php $_from = $this->_tpl_vars['rec']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['newslist'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['newslist']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['RS']):
        $this->_foreach['newslist']['iteration']++;
?>
			  				  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="TableLoopCaseStudy">
                <tr>
                  <td><table width="100%" height="124" border="0" cellpadding="0" cellspacing="0" style="background:url(images/bg_case_study.gif) center no-repeat">
                    <tr>
                      <td width="180" align="center" valign="middle"><?php if ($this->_tpl_vars['RS']['image1'] != NULL): ?><a href="tips_detail.php?/<?php echo $this->_tpl_vars['RS']['tid']; ?>
"><img src="img_tips/thumbnail/<?php echo $this->_tpl_vars['RS']['image1']; ?>
" width="148" height="159" border="0" />
									</a><?php endif; ?></td>
                      <td width="6" valign="top">&nbsp;</td>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="20" valign="top"><a href="tips_detail.php?/<?php echo $this->_tpl_vars['RS']['tid']; ?>
" class="TextGreen12B01" id="TopicCaseStaudy" onmouseover="MM_swapImage('ArrowNews1','','images/icon_zoom_green.gif',1)" onmouseout="MM_swapImgRestore()">
                          ...
                          <tr>
                            <td valign="top" class="TextGray11N02"><?php echo ((is_array($_tmp=$this->_tpl_vars['RS']['description'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)); ?>
</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="64"><a href="tips_detail.php?/<?php echo $this->_tpl_vars['RS']['tid']; ?>
" ><img src="images/button_detail.gif" width="64" height="14" border="0" /></a></td>
                                  <td align="right"><strong>ข้อมูลวันที่ : </strong> <span class="TextGreenN01"><?php echo ((is_array($_tmp=$this->_tpl_vars['RS']['date_tips'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%y") : smarty_modifier_date_format($_tmp, "%d-%m-%y")); ?>
</span></td>
                                </tr>
                            </table></td>
                          </tr>
...
?>
                                    <a href="tips.php?/<?php echo $this->_sections['i']['index']; ?>
...
?>
                                   <span style="margin:5px">-</span><a href="tips.php?/<?php echo $this->_sections['j']['index']; ?>
" class="TextGreen12B02">
                                    ...
                                    <a href="tips.php?/<?php echo $this->_tpl_vars['nextpage']; ?>
">
