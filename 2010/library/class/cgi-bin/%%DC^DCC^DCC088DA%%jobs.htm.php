<?php /* Smarty version 2.6.18, created on 2010-09-26 23:29:42
         compiled from jobs.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'jobs.htm', 259, false),)), $this); ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="990" valign="top"><?php include("inc_menu_top_jobs.php");?>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','471','height','324','src','flash/toppic_jobspro','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','flash/toppic_jobspro' ); //end AC code
                ...
                <param name="movie" value="flash/toppic_jobspro.swf" />
                <param name="quality" value="high" />
                <param name="wmode" value="transparent" />
                <embed src="flash/toppic_jobspro.swf" width="471" height="324" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="transparent"></embed>
              </object>
</noscript></td>
            </tr>
          </table></td>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','317','height','99','src','flash/toppic_career','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','flash/toppic_career' ); //end AC code
                    ...
                    <param name="movie" value="flash/toppic_career.swf" />
                    <param name="quality" value="high" />
                    <param name="wmode" value="transparent" />
                    <embed src="flash/toppic_career.swf" width="317" height="99" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="transparent"></embed>
                  </object>
</noscript></td>
                  <td>&nbsp;</td>
                </tr>
            ...
            <tr>
              <td height="184" valign="top"><table width="100%" height="60" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td>&nbsp;</td>
                </tr>
              </table>    
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','282','height','53','src','flash/topic_jobs2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','wmode','transparent','movie','flash/topic_jobs2' ); //end AC code
                      ...
                      <param name="movie" value="flash/topic_jobs2.swf" />
                      <param name="quality" value="high" />
                      <param name="wmode" value="transparent" />
                      <embed src="flash/topic_jobs2.swf" width="282" height="53" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="transparent"></embed>
                    </object>
</noscript></td>
                    <td width="24">&nbsp;</td>
                  </tr>
...
?>
			  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="LoopPosition">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td width="388"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        <td width="18"><img src="images/bg_line45_blue2.gif" width="18" height="27" /></td>
                          <td bgcolor="#21c5c7" class="TextWhite12B01"><img src="images/arrow_white.gif" style="margin-left:10px; margin-right:10px" /><?php echo $this->_tpl_vars['RS']['job_position']; ?>
</td>
                          <td width="18"><img src="images/bg_line45_blue.gif" width="18" height="27" /></td>
                        </tr>
                      </table></td>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        ...
                        <tr>
                          <td align="right"><span class="TextRed12B02" style="margin-right:7px">[<?php echo $this->_tpl_vars['RS']['job_person']; ?>
]</span><span class="TxtGray12B02" style="margin-right:5px">ตำแหน่ง</span> </td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></td>
                ...
                <tr>
                  <td height="1" bgcolor="#05999b"></td>
                </tr>
                <tr>
                  <td><table width="130" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td bgcolor="#05999b"><img src="images/spacer.gif" width="1" height="1" /></td>
                      <td width="4"><img src="images/bg_line45green.gif" width="4" height="6" /></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table width="388" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td width="26">&nbsp;</td>
                      <td>
					  		  <?php if ($this->_tpl_vars['RS']['job_description'] != ""): ?>
					  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="CareerDetail">
                        <tr>
                          <td class="TextBlue12B01">รายละเอียด</td>
                        </tr>
                        <tr>
                          <td height="3"></td>
                        </tr>
                        <tr>
                          <td class="TextGray12N01"><?php echo ((is_array($_tmp=$this->_tpl_vars['RS']['job_description'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)); ?>
 </td>
                        </tr>
                        <tr>
                          <td height="7"></td>
					  		  ...
					  		  <?php endif; ?>
	<?php if ($this->_tpl_vars['RS']['job_detail'] != NULL): ?>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="CareerQuality">
                          <tr>
                            <td class="TextBlue12B01">คุณสมบัติ</td>
                          </tr>
                          <tr>
                            <td height="3"></td>
                          </tr>
                          <tr>
                            <td class="TextGray12N01"><?php echo ((is_array($_tmp=$this->_tpl_vars['RS']['job_detail'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)); ?>
</td>
                          </tr>
                          <tr>
                            <td height="7"></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="26" valign="bottom"><img src="images/arrow_gray.gif" width="8" height="7" style="margin-left:10px; margin-bottom:2px" /></td>
                        <td><a href="jobapplication.php?/<?php echo $this->_tpl_vars['RS']['job_id']; ?>
" class="TextGray12B01">สมัครงานออนไลน์</a></td>
                      </tr>
                    </table></td>
                </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td><?php if ($this->_tpl_vars['prevpage'] !== NULL): ?>
                                    <a href="tips.php?/<?php echo $this->_tpl_vars['prevpage']; ?>
