<?php /* Smarty version 2.6.18, created on 2010-09-26 17:15:02
         compiled from news.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'news.htm', 243, false),array('modifier', 'stripslashes', 'news.htm', 253, false),array('modifier', 'substring', 'news.htm', 253, false),)), $this); ?>
              ...
              <td width="633" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="200" valign="top"><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
                   ...
                   <?php $_from = $this->_tpl_vars['rec']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['newslist'] = array('total' => count($_from), 'iteration' => 0);
                    ...
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="NewsContent">
                        <tr>
                          <td width="176" valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="border_gray">
                              <tr>
                                <td align="center" width="168" height="90" style="background:url(images/bg_defaults.jpg) top center no-repeat"><?php if ($this->_tpl_vars['RS']['image1'] != NULL): ?><a href="news_detail.php?/<?php echo $this->_tpl_vars['RS']['nid']; ?>
"><img src="img_news/thumbnail/<?php echo $this->_tpl_vars['RS']['image1']; ?>
" width="168" height="90" border="0" /></a><?php endif; ?></td>
                              </tr>
                          </table></td>
                          <td width="30">&nbsp;</td>
  ...
  <tr>
    <td width="22" valign="top"><img src="images/icon_zoom_green.gif" width="22" height="22" /></td>
                          ...
                          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td width="11">&nbsp;</td>
                                <td class="TextGray12N01"><strong>ข้อมูลวันที่ :</strong> <span class="TextGreenB01"><?php echo ((is_array($_tmp=$this->_tpl_vars['RS']['date_news'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%y") : smarty_modifier_date_format($_tmp, "%d-%m-%y")); ?>
</span></td>
                              ...
                              <tr>
                                ...
                                <td><a href="news_detail.php?/<?php echo $this->_tpl_vars['RS']['nid']; ?>
" class="TextBlue14B01" ><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['RS']['subject'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)))) ? $this->_run_mod_handler('substring', true, $_tmp, 1, 100) : smarty_modifier_substring($_tmp, 1, 100)); ?>
</a></td>
                                <td>&nbsp;</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td>&nbsp;</td>
                                <td><div align="justify" class="TextGray12N01"><?php echo ((is_array($_tmp=$this->_tpl_vars['RS']['description'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)); ?>
</div></td>
                                <td>&nbsp;</td>
                              </tr>
                          </table></td>
