<?php /* Smarty version 2.6.18, created on 2010-09-26 17:20:44
         compiled from tips_detail.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'tips_detail.htm', 218, false),array('modifier', 'date_format', 'tips_detail.htm', 224, false),array('modifier', 'filesize_format', 'tips_detail.htm', 376, false),)), $this); ?>
        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="57" valign="top"><img src="images/balloon_curve_t3.gif" alt="" width="114" height="45" /></td>
              <td width="633" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="img_tips/fullsize/<?php echo $this->_tpl_vars['image']; ?>
"  /></td>
                    </tr>
                    <tr>
                      <td height="46">&nbsp;</td>
					  ...
					  <table width="109" border="0" cellpadding="0" cellspacing="0" id="PicNewsLoop1" style="float:left">
                          <tr>
                            <td width="100" align="center" valign="middle"><table width="100%" height="80" border="0" cellpadding="0" cellspacing="0" class="border_Green">
                                <tr>
                                  <td align="center" valign="middle"><a href="img_tips/fullsize/<?php echo $this->_tpl_vars['RS1']['image2']; ?>
...
"   class="lightbox"><img src="img_tips/thumbnail/<?php echo $this->_tpl_vars['RS1']['image1']; ?>
"  border="0" /></a></td>
                                </tr>
                            </table></td>
                            <td>&nbsp;</td>
					...
					<?php else: ?>	
                          <table width="108" border="0" cellpadding="0" cellspacing="0" id="PicNewsLoop2">
                            <tr>
                              <td width="100" align="center" valign="middle"><table width="100%" height="80" border="0" cellpadding="0" cellspacing="0" class="border_Green">
                                  <tr>
                                    <td align="center" valign="middle"><a href="img_tips/thumbnail/<?php echo $this->_tpl_vars['RS1']['image2']; ?>
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['RS1']['caption'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : smarty_modifier_stripslashes($_tmp)); ?>
"  class="lightbox"><img src="img_tips/thumbnail/<?php echo $this->_tpl_vars['RS1']['image']; ?>
"  border="0" /></a></td>
                                  </tr>
                              </table></td>
                            </tr>
