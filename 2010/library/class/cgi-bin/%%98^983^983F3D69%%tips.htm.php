<?php /* Smarty version 2.6.18, created on 2010-06-10 20:03:48
         compiled from tips.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'tips.htm', 198, false),array('modifier', 'substring', 'tips.htm', 198, false),array('modifier', 'date_format', 'tips.htm', 222, false),)), $this); ?>
            ...
            <tr>
              ...
              <td width="633" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="200" valign="top"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
                  </table><?php $_from = $this->_tpl_vars['rec']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['newslist'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr valign="top">
                        <td width="26">&nbsp;</td>
                        <td>
							  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="TableNewsLoop">
                          <tr>
                            <td width="22" valign="top"><img src="images/icon_zoom_green.gif" width="22" height="22" /></td>
                            <td width="13" valign="top">&nbsp;</td>
                            <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr valign="top">
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td valign="top" class="TextBlue14B01"><a href="tips_detail.php?/<?php echo $this->_tpl_vars['RS']['tid']; ?>
" class="TextBlue14B01" onmouseover="MM_swapImage('ArrowNews1','','images/icon_zoom_green.gif',1)" onmouseout="MM_swapImgRestore()">
                                  ...
                                  <tr>
                                    <td class="TextGray12N01"><div align="justify">
                                ...
                                <td width="27">&nbsp;</td>
                                <td align="center" width="168" height="109" style="background:url(images/bg_defaults.jpg) top center no-repeat"><?php if ($this->_tpl_vars['RS']['image1'] != NULL): ?><a href="tips_detail.php?/<?php echo $this->_tpl_vars['RS']['tid']; ?>
"><img src="img_tips/thumbnail/<?php echo $this->_tpl_vars['RS']['image1']; ?>
" width="168" height="129" border="0" />
									</a><?php endif; ?></td>
                              </tr>
                            </table>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="155"><strong>ข้อมูลวันที่ :</strong>&nbsp;&nbsp;<span class="TextGreenN01"><?php echo ((is_array($_tmp=$this->_tpl_vars['RS']['date_tips'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%y") : smarty_modifier_date_format($_tmp, "%d-%m-%y")); ?>
</span> </td>
                                      <td width="10">&nbsp;</td>
                                      <td><a href="tips_detail.php@page=1" ><img src="images/button_detail.gif" width="64" height="14" border="0" /></a></td>
                                    </tr>
                                  </table></td>
                                </tr>
