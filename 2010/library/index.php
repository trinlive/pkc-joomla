...
$SQLstr_book =  " SELECT * FROM `book_libraries` WHERE `book_status` = 'Active' ORDER BY `book_id` desc";
...
<link href="css/pobsook.css" rel="stylesheet" type="text/css" /> 
 <script language="javascript">
	...
	{
		alert('fdsfsd');
		if(document.formsearch.keysearch.selectedIndex == default)
			{
				alert('lkfgfgsfdg');
...
<table width="975" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
     <td height="1" style="background:url(images/border_vertical.gif) repeat-x;" colspan="2"></td>
      ...
      <tr>
        <td colspan="4"><div align="center" class="txtBlue11b04">ชนิดเอกสาร</div></td>
      </tr>
      <tr>
        <td width="15"><div align="right"></div></td>
        <td width="34"><img src="images/icon_book.gif" width="30" height="30" /></td>
        <td width="11">&nbsp;</td>
        <td width="167" class="txtGreen12B05">หนังสือ</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><img src="images/icon_copy.gif" width="30" height="30" /></td>
        <td>&nbsp;</td>
        <td class="txtGreen12B05">เอกสารถ่ายสำเนา</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td><div align="right"></div></td>
        <td><img src="images/cd.gif" width="30" height="30" /></td>
        <td>&nbsp;</td>
        <td class="txtGreen12B05">CD/File ข้อมูล</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td><div align="right"></div></td>
        <td><img src="images/icon_doc.gif" width="30" height="30" /></td>
        <td>&nbsp;</td>
        <td class="txtGreen12B05">เอกสารประชาสัมพันธ์</td>
      </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <td style="position:relative"> </td>
                                                ...
                                                <td width="31" height="218" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td height="154" bgcolor="#FFFFFF">&nbsp;</td>
                                                  </tr>
                                                    </table></td>
                                                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                ...
                <table width="975" height="950" border="0" align="center" cellpadding="0" cellspacing="0" class="table_content">
                    <tr valign="top">
                        ...
                        <td width="655"><table width="100%" height="15" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <form action="search_list.php" method="get" enctype="multipart/form-data" id="formsearch" name="formsearch">
                            
                                <fieldset>
                                <div style="width:100%; height:30px">
                                <div style="float:left">หมวดเอกสาร:
                                <select name="keysearch" class="border_bg_violet" id="keysearch" >
                 <option value="default">--กรุณาเลือกหัวข้อหลัก--</option>
                   <?php  while (!$rscate->EOF): ?> <option value="<?php echo $rscate->fields['cate_id'] ;?>"><?php echo $rscate->fields['cate_name'] ;?></option>               
                <?php $rscate->MoveNext();?>
				<?php endwhile ;?></select>
                                </div></div>
                                <div style="width:100%; height:30px">
                                <div style="float:left">ชื่อเรื่อง/รายละเอียด :<input type="text" name="title_book" id="title_book" /></div>
                                </div>
                                
                                <div style="width:100%; height:30px">
                                <div style="float:left">หน่วยงานเจ้าของเรื่อง :<input type="text" name="ower_book" id="ower_book" /></div>
                                </div>
                            ...
                            <table width="100%"  height="120" border="0" cellpadding="0" cellspacing="0">
                                <tr valign="top">
                                    <td>
                                    <table width="100%" height="25" border="0"  cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
    <tr>
    <td width="90" align="center"  class="txtGreen12BL01">ลำดับ</td>
    <td width="380" align="center" class="txtGreen12BL01">ชื่อเรื่อง/รายละเอียด</td>
    <td width="100" align="center"  class="txtGreen12BL01">ชนิดเอกสาร</td>
    <td width="90" align="center"  class="txtGreen12BL01">สถานะ</td>
  </tr>
  </table>
                               <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="90" align="center">
     <?php
     $book_id = $rs_book->fields['book_id'];
	 echo "<span class=txtGray11N04>".sprintf("%05d", $book_id)."</span>";
	 ?>    </td>
    <td width="380" height="22"><a href="detail.php?book_id=<?php echo $rs_book->fields['book_id'] ?>" class="txtBlue12B04" ><?php echo $rs_book->fields['book_name'] ?></a></td>
    <td width="100" align="center">
    <?php
    $book_type = $rs_book->fields['book_type'];
	if($book_type =="book"){
	echo '<img src="images/icon_book.gif">';
	}elseif($book_type =="copy"){
	echo '<img src="images/icon_copy.gif">';
	}elseif($book_type =="promotion"){
	echo '<img src="images/icon_doc.gif">';
	}elseif($book_type =="cd"){
	echo '<img src="images/cd.gif">';
	}	
	?>    </td>
    <td align="center">
	<?php 
	$book_now = $rs_book->fields['book_now'];
	if($book_now =="have"){
	echo '<span class="txtGreen12B05">มีอยู่</span>';
	}else{
	echo '<span class="txtRed11N03">ถูกยืมไป</span>';
	}
	?>    </td>
  </tr>
  <tr>
     <td height="1" style="background:url(images/border_vertical.gif) repeat-x;" colspan="4"></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td align="center" class="text_black12_bold">
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="234" rowspan="7" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="1"></td>
                </tr>
                <tr>
            ...
            <td width="26" rowspan="7">&nbsp;</td>
            <td valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top"></td>
                    <td width="183" height="66" rowspan="3" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="10"></td>
                        </tr>
                      </table>                        </td>
          ...
          <tr>
            <td valign="top" class="txtGray12B01">ศูนย์ข้อมูลข่าวสารเทศบาลนครปากเกร็ด</td>
          </tr>
          <tr>
            <td valign="top">กองวิชาการและแผนงาน เทศบาลนครปากเกร็ด</td>
          </tr>
          <tr>
            <td valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td valign="top">ออกแบบและพัฒนาระบบโดย กองวิชาการและแผนงาน เทศบาลนครปาเกเกร็ด</td>
          </tr>
          <tr>
            <td valign="top">&nbsp;</td>
          </tr>
