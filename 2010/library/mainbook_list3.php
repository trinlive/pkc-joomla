                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="NewsContent">
                        <tr>
                          <td width="128" valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="border_gray">
                              <tr>
                                <td align="center" width="120" height="159" style="background:url(images/bg_defaults.jpg) top center no-repeat"><a href="detail.php?book_id=<?php echo $rs_book->fields['book_id'] ?>"><img src="img_book/thumbnail/<?php echo $rs_book->fields['book_images'] ?>" width="120" height="159" border="0" /></a></td>
                              </tr>
                          </table></td>
                          <td width="30">&nbsp;</td>
