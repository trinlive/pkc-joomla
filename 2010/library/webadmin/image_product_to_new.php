        ...
        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="background:url(images/line_main.gif) repeat-y">
          <tr valign="top">
            ...
            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left"><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
                      <tr>
                        <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Add Image Product </span></td>
                  ...
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                      <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="8">&nbsp;</td>
                            <td valign="top"><?php if (!$rs->EOF):?><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                                              ...
                                              <tr>
                                                <td width="60" align="center" class="text_gray_normal"><a  href="image_product_new.php?tid=<?php echo $rs->fields['tid'] ?>" class="text_gray_normal"><?php echo $i; ?></a></td>
                                                <td class="text_gray_normal"><a href="image_product_new.php?tid=<?php echo $rs->fields['tid'] ?>" class="text_violet_normal"><?php echo $rs->fields['name_product'] ?>&nbsp;&nbsp;<?php echo $rs->fields['product_version'] ?></a></td>
				...
				echo '<b><font color="#0000FF">HIDE</font></b>';
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr class="text_black12_bold">
                                    <td align="center"><?php echo $GenericEasyPagination->getCurrentPages(); ?><?php echo $GenericEasyPagination->getNavigation(); ?></td>
