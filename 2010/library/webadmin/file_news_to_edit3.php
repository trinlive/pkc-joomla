...
$GenericEasyPagination->getsVars = "nid=$nid" ;

$SQLstr2 = "SELECT * FROM newses WHERE newses.nid = '".$nid."' ORDER BY nid DESC ";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Edit File News </span></td>
          ...
          <tr valign="top">
            ...
            <td>
              <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="14%" valign="top"><?php if (!$rs->EOF):?>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                                              ...
                                              <tr>
                                                <td width="60" align="center" class="text_gray_normal"><a  href="file_news_to_edit4.php?nid=<?php echo $rs->fields['nid'] ?>&fileid=<?php echo $rs->fields['fileid']?>" class="text_gray_normal"><?php echo $rs->fields['fileid'] ?></a></td>
                                                <td class="text_gray_normal"><a href="file_news_to_edit4.php?nid=<?php echo $rs->fields['nid'] ?>&fileid=<?php echo $rs->fields['fileid']?>" class="text_violet_normal"><?php echo $rs->fields['topic'] ?></a></td>
                ...
                <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr class="text_black12_bold">
                                    <td align="center"><?php echo $GenericEasyPagination->getNavigation_prev(); ?>
