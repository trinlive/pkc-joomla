                        ...
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                            <tr>
                              <td><table width="100%" border="0" cellspacing="2" cellpadding="0" bordercolor="#F7F7F7" align="center">
                                  ...
                                  <tr>
                                    <td height="20" align="center" class="text_gray_normal"><a  href="image_news_to_delete2.php?news_type=News" class="text_gray_normal">1</a></td>
                                    <td class="text_gray_normal">&nbsp;<a  href="image_news_to_delete2.php?news_type=News" class="text_violet_normal">ข่าวรวม</a></td>
                                  </tr>
                                  <tr>
                                    <td height="1" colspan="2" align="center" class="text_gray_normal"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#def8f8">
                                    <tr>
                                  ...
                                  <tr>
                                    <td height="20" align="center" class="text_gray_normal"><a  href="image_news_to_delete2.php?news_type=news-cable" class="text_gray_normal">2</a></td>
                                    <td class="text_gray_normal">&nbsp;<a  href="image_news_to_delete2.php?news_type=news-cable" class="text_violet_normal">ข่าวเคเบิ้ลทีวี</a></td>
                                  </tr>
                                  <tr>
                                    ...
                                    <tr>
                                    <td height="20" align="center" class="text_gray_normal"><a  href="image_news_to_delete2.php?news_type=news-security" class="text_gray_normal">3</a></td>
                                    <td class="text_gray_normal">&nbsp;<a  href="image_news_to_delete2.php?news_type=news-security" class="text_violet_normal">กิจกรรม ของ รปภ</a></td>
                                  </tr>
                                  <tr>
                                    <td colspan="4" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#def8f8">
                                    <tr>
                                    ...
                                    <tr>
                                    <td height="20" align="center" class="text_gray_normal"><a  href="image_news_to_delete2.php?news_type=news-home" class="text_gray_normal">4</a></td>
                                    <td class="text_gray_normal">&nbsp;<a  href="image_news_to_delete2.php?news_type=news-home" class="text_violet_normal">ข่าวบ้านเอื้อาทร</a></td>
                                  </tr>
                                  <tr>
                                    <td colspan="4" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#def8f8">
                                    <tr>
                                    ...
                                    <tr>
                                    <td height="20" align="center" class="text_gray_normal"><a  href="image_news_to_delete2.php?news_type=news-awards" class="text_gray_normal">5</a></td>
                                    <td class="text_gray_normal">&nbsp;<a  href="image_news_to_delete2.php?news_type=news-awards" class="text_violet_normal">ข่าวลงหนังสือพิมพ์</a></td>
                                  </tr>
                                  <tr>
                                    <td colspan="4" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#def8f8">
                                    <tr>
