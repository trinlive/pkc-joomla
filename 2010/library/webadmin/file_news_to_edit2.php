                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                                              ...
                                              <tr>
                                                <td width="60" align="center" class="text_gray_normal"><a  href="file_news_to_edit3.php?nid=<?php echo $rs->fields['nid'] ?>" class="text_gray_normal"><?php echo $rs->fields['nid'] ?></a></td>
                                                <td class="text_gray_normal"><a href="file_news_to_edit3.php?nid=<?php echo $rs->fields['nid'] ?>" class="text_violet_normal"><?php echo $rs->fields['subject'] ?></a></td>
