...
$GenericEasyPagination->getsVars = "tid=$tid" ;

$SQLstr2 = "SELECT * FROM tips WHERE tips.tid = '".$tid."' ORDER BY tid DESC ";
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                                              ...
                                              <tr>
                                                <td width="60" align="center" class="text_gray_normal"><a  href="file_tips_to_edit4.php?tid=<?php echo $rs->fields['tid'] ?>&fileid=<?php echo $rs->fields['fileid']?>" class="text_gray_normal"><?php echo $rs->fields['fileid'] ?></a></td>
                                                <td class="text_gray_normal"><a href="file_tips_to_edit4.php?tid=<?php echo $rs->fields['tid'] ?>&fileid=<?php echo $rs->fields['fileid']?>" class="text_violet_normal"><?php echo $rs->fields['topic'] ?></a></td>
