            ...
            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left"><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
                      <tr>
                        <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Add File tips </span></td>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                                              ...
                                              <tr>
                                                <td width="60" align="center" class="text_gray_normal"><a  href="file_tips_new.php?tid=<?php echo $rs->fields['tid'] ?>" class="text_gray_normal"><?php echo $i; ?></a></td>
                                                <td class="text_gray_normal"><a href="file_tips_new.php?tid=<?php echo $rs->fields['tid'] ?>" class="text_violet_normal"><?php echo $rs->fields['subject'] ?></a></td>
