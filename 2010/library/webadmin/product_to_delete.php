...
if($_GET[actions]=="del"):
	...
	$SQLstr = "SELECT * FROM products WHERE tid = '".$gettmp[tid]."' ";
	...
	if ($gettmp[pimage3] != "") :
		if(file_exists("../img_pro/tiny/$gettmp[pimage3]")) unlink("../img_pro/tiny/$gettmp[pimage3]");
	endif ;	
	
	$SQLstr2 = " SELECT * FROM `products_images` WHERE `products_images`.`tid` =  '".$gettmp[tid]."' ";
	...
	$product->Delete();
	if($product):
			$getdata[msg].="<meta http-equiv=\"refresh\" content=\"0; URL=product_to_delete.php\">";	
...
$SQLstr = "SELECT * FROM products  ORDER BY tid DESC";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Delete Products </span></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top"><form action="product_action.php" style="margin:0" method="post"  name="form1" id="form1" onSubmit="return checkForm();">
                        ...
                        <td valign="top" bgcolor="#FFFFFF" class="text_black_bold"><?php if (!$rs->EOF):?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            ...
                            <tr>
                              ...
                              <td width="60" height="20" align="center" class="text_gray_normal"><a href="product_edit.php?tid=<?php echo $rs->fields['tid'] ?>"class="text_gray_normal"><?php echo $i; ?></a></td>
                              <td><span class="text_gray_normal"><a href="product_edit.php?tid=<?php echo $rs->fields['tid'] ?>" class="text_violet_normal"><?php echo stripslashes($rs->fields['name_product'])?>&nbsp;&nbsp;<?php echo stripslashes($rs->fields['product_version'])?></a></span></td>
                              <td width="80" align="center" class="arialGREY11nor"><?php if ($rs->fields['product_active'] == 'Active'):
