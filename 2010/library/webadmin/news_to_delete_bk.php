...
if($_GET[actions]=="del"):
	...
	if ($gettmp[pimage1] != "") :
		if(file_exists("../img_news/thumbnail/$gettmp[pimage1]")) unlink("../img_news/thumbnail/$gettmp[pimage1]");
	endif ;
	if ($gettmp[pimage2] != "") :
		if(file_exists("../img_news/fullsize/$gettmp[pimage2]")) unlink("../img_news/fullsize/$gettmp[pimage2]");
	endif ;
	if ($gettmp[pimage3] != "") :
		if(file_exists("../img_news/tiny/$gettmp[pimage3]")) unlink("../img_news/tiny/$gettmp[pimage3]");
	endif ;	
	...
	while (!$rsdel2->EOF):
			...
			if ($pic_pimage1 != "") :
					if(file_exists("../img_news/thumbnail/$pic_pimage1")) unlink("../img_news/thumbnail/$pic_pimage1");
			endif ;	
	...
	$news->Delete();
	if($news):
			$getdata[msg].="<meta http-equiv=\"refresh\" content=\"0; URL=news_to_delete.php\">";	
                        ...
                        <td valign="top" bgcolor="#FFFFFF" class="text_black_bold"><?php if (!$rs->EOF):?>
                          <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            <tr align="center" bgcolor="#1bb3b3" class="arialWH11B">
                              ...
                              <td width="60" height="25" bgcolor="#1bb3b3">ID</td>
                              <td>SUBJECT</td>
                            ...
                            <tr>
                              ...
                              <td width="60" height="20" align="center" class="text_gray_normal"><a href="news_edit.php?nid=<?php echo $rs->fields['nid'] ?>"class="text_gray_normal"><?php echo $i; ?></a></td>
