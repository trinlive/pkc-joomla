    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head05.gif">
          <tr>
            <td width="228" height="29"><span class="arialWH18B" style="margin-left:8px;">Delete File News</span></td>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                                              ...
                                              <tr>
                                                <td width="60" align="center" class="text_gray_normal"><a  href="file_news_to_delete3.php?nid=<?php echo $rs->fields['nid'] ?>" class="text_gray_normal"><?php echo $rs->fields['nid'] ?></a></td>
                                                <td class="text_gray_normal"><a href="file_news_to_delete3.php?nid=<?php echo $rs->fields['nid'] ?>" class="text_violet_normal"><?php echo $rs->fields['subject'] ?></a></td>
