                  ...
                  <tr>
                    <td><table width="99%" border="0" cellspacing="2" cellpadding="0" align="center">
                      ...
                      <tr>
                        ...
                        <td valign="top" class="text_gray_normal"><a  href="letter_edit.php?news_id=<?php echo $rs->fields['news_id'] ?>" class="text_gray_normal"> <?php echo $rs->fields['subject'] ?></a></td>
