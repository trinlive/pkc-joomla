...
$SQLstr = " SELECT `tips`.`subject`,`tips_images`.`id`,`tips`.`tid`,`tips_images`.`image1`, `tips_images`.`image_active` FROM `tips`Inner Join `tips_images` ON `tips`.`tid` = `tips_images`.`tid` AND `tips`.`tid` = `tips_images`.`tid` where `tips`.`tid`= '$tid' ";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Edit Image Tips</span></td>
        ...
        <td></td>
                                ...
                                <tr>
                                  ...
                                  <td class="text_gray_normal"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="90"><a href="image_tips_edit.php?id=<?php echo $rs->fields['id'] ?>&tid=<?php echo $rs->fields['tid'] ?>"><img src="../img_tips/thumbnail/<?php echo $rs->fields['image1']?>" border="0"></a></td>
                                      <td>&nbsp;</td>
                                    </tr>
                                  </table></td>
