	...
	$gettmp['nid'] = $_GET['nid'];
		...
		ADOdb_Active_Record::SetDatabaseAdapter($db);
			...
			$news_file = new news_file();
					...
					$SQLstr = " SELECT * FROM news_files WHERE news_files.fileid =  '".$gettmp['fileid']."' ";
					...
					$news_file->load("fileid=?", array($gettmp['fileid']));
					$news_file->Delete();
	
				
		saverecord('Delete Press Center');	
		echo "<meta http-equiv=\"refresh\" content=\"2; URL=file_news_to_delete3.php?nid=".$gettmp['nid']."\">";
		exit();
	#endif ;		
} // ลบ
?>
...
$SQLstr = "SELECT * FROM news_files WHERE nid = '".$nid."' ORDER BY fileid DESC ";
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="background:url(images/line_main.gif) repeat-y">
  <tr valign="top">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><form name="form1" method="post" action="file_action.php" onSubmit="return checkForm();">
            ...
            <td><?php if (!$rs->EOF):?>
              <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                ...
                <tr>
                  ...
                  <td width="60" height="20" align="center" class="text_gray_normal"><a href="file_news_to_edit4.php?fileid=<?php echo $rs->fields['fileid'] ?>&nid=<?php echo $rs->fields['nid'] ?>"class="text_gray_normal"><?php echo $rs->fields['fileid'] ?></a></td>
                  <td><span class="text_gray_normal"><a href="file_news_to_edit4.php?fileid=<?php echo $rs->fields['fileid'] ?>&nid=<?php echo $rs->fields['nid'] ?>" class="text_violet_normal"><?php echo stripslashes($rs->fields['topic'])?></a></span></td>
				...
				echo '<b><font color="#FF0000">HIDE</font></b>';
                  ...
                  <td width="35" align="center"><a href="?actions=del&fid=<?php echo $rs->fields['fileid'] ?>&nid=<?php echo $rs->fields['nid']?>" onClick="return  confirm('Do you want to delete? ');"><img src="images/del_button.gif" width="13" height="13" border="0" /></a></td>
                </tr>
                <?php $rs->MoveNext(); ?>
                <?php endwhile; ?>
                <tr>
