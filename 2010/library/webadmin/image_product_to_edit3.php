...
$SQLstr = " SELECT `products`.`name_product`,`products_images`.`id`,`products`.`tid`,`products_images`.`image1`, `products_images`.`image_active` FROM `products`Inner Join `products_images` ON `products`.`tid` = `products_images`.`tid` AND `products`.`tid` = `products_images`.`tid` where `products`.`tid`= '$tid' ";
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				          ...
				          <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
							  ...
							  <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF" align="center">
                                <tr>
                                  <td colspan="3" align="center" class="text_gray_normal"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#E5D9EC">
      <tr>
        <td></td>
      </tr>
    </table></td>
                                ...
                                <tr>
                                  <td width="60" height="52" align="center" class="text_gray_normal"><?php echo $i; ?></td>
                                  <td class="text_gray_normal"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="90"><a href="image_product_edit.php?id=<?php echo $rs->fields['id'] ?>&tid=<?php echo $rs->fields['tid'] ?>"><img src="../img_pro/thumbnail/<?php echo $rs->fields['image1']?>" border="0"></a></td>
                                      <td>&nbsp;</td>
                                    </tr>
                                  </table></td>
