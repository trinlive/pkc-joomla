...
<table width="100%" border="0" cellspacing="2" cellpadding="0" bordercolor="#FFFFFF" align="center">
  ...
  <tr>
    <td width="60" height="20" align="center" valign="top"><a  href="jobs_edit.php?job_id=<?php echo $rs->fields['job_id'] ?>" class="text_gray_normal"><?php echo $rs->fields['job_id'] ?></a></td>
    <td valign="top"><a href="jobs_edit.php?job_id=<?php echo $rs->fields['job_id'] ?>" class="text_violet_normal"><?php echo $rs->fields['job_position']?></a></td>
