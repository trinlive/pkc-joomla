...
`tips`.`tid`,
`tips`.`subject` as newsubject
FROM
`tips`
Inner Join `tips_images` ON `tips`.`tid` = `tips_images`.`tid` where `tips_images`.`id` = '$id' ";
$rs = $db->Execute($stmt) ;
?>
<html>
<head>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top">
                  <form action="image_tips_action.php" method="POST" enctype="multipart/form-data" name="form1" style="margin:0">
                      <table width="99%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td valign="top" class="arialVIO11"><?php if($rs->fields['image2'] != "") :?><img src="../img_tips/fullsize/<?php echo $rs->fields['image2']?>" width="450" height="338" border="0">
