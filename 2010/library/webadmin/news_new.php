    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Add News</span></td>
          ...
          <tr valign="top">
            ...
            <td><form action="news_action.php" method="post" enctype="multipart/form-data" name="form1" id="form1" style="margin:0" onSubmit="return checkForm();">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td class="arialVIO11B">CATEGORY : </td>
                  <td valign="top" class="text_black_bold"><select name="news_type" class="border_bg_violet" id="news_type">
                    <option value="News">ข่าวรวม</option>
                    <option value="News-Awards">ข่าวลงหนังสือพิมพ์</option>
                    <option value="News-Cable">ข่าวเคเบิ้ลทีวี</option>
                    <option value="News-Security">กิจกรรม ของ รปภ</option>
                    <option value="News-Home">ข่าวบ้านเอื้อาทร</option>
                  </select></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input name="subject" type="text" class="border_bg_violet" id="subject" style="width:70%" /></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="text_black_bold"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                    <tr>
				...
				<tr>
                  ...
                  <td><textarea name="description" rows="5" class="border_bg_violet" id="description" style="width:70%"></textarea></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="text_black_bold"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                    <tr>
                ...
                <tr>
                  <td width="162" valign="top" class="text_black_bold"><span class="arialVIO11B">DETAIL  :</span></td>
                ...
                <tr>
                  ...
                  <td valign="top" class="arialVIO11"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="arialVIO11">
                    <tr>
                      <td width="70%"><input name="image3" type="file" class="border_bg_violet" id="image3" style="width:100%" /></td>
