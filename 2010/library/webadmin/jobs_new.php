    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Add Jobs </span></td>
            <td align="right">&nbsp; &nbsp; </td>
            <td width="50">&nbsp; &nbsp;</td>
          </tr>
        </table></td>
            ...
            <td><form action="jobs_action.php" method="post" enctype="multipart/form-data"  name="form" style="margin:0;"  onSubmit="return checkForm();">
              <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td valign="top"><input name="job_position" type="text" class="border_bg_violet" id="job_position" style="width:70%"></td>
                </tr>
                <tr>
				  ...
				  <tr>
				    <td colspan="2" valign="top" class="arialVIO11B"><textarea name="job_description" class="border_bg_gray" id="job_description" style="width:100%; height:200"></textarea></td>
				    </tr>
					<tr>
                ...
                <tr>
                  <td colspan="3" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                    ...
                    <tr>
                      <td colspan="2" valign="top" class="arialVIO11B"><textarea name="job_detail" class="border_bg_gray" id="job_detail" style="width:100%; height:200"></textarea></td>
                    </tr>
					<tr>
                  <td colspan="2" valign="top" class="text_black_bold">&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <td valign="top" class="text_black_bold"><input name="job_person" type="text" class="border_bg_violet" id="job_person" size="85" maxlength="100"></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                      <tr>
