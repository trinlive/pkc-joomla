        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td><table width="99%" border="0" cellspacing="2" cellpadding="0" align="center">
              ...
              <tr>
                <td width="60" align="center" valign="top" class="text_gray_normal"><a  href="letter_to_send2.php?news_id=<?php echo $rs->fields['news_id'] ?>" class="text_gray_normal">
              <?php echo $rs->fields['news_id'] ?>
              </a></td>
                <td valign="top" class="text_gray_normal"><a  href="letter_to_send2.php?news_id=<?php echo $rs->fields['news_id'] ?>" class="text_violet_normal">
