                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                                              ...
                                              <tr>
                                                <td width="60" align="center" class="text_gray_normal"><a  href="image_product_to_edit3.php?tid=<?php echo $rs->fields['tid'] ?>" class="text_gray_normal"><?php echo $i; ?></a></td>
                                                <td class="text_gray_normal"><a href="image_product_to_edit3.php?tid=<?php echo $rs->fields['tid'] ?>" class="text_violet_normal"><?php echo stripslashes($rs->fields['name_product']); ?>&nbsp;&nbsp;<?php echo stripslashes($rs->fields['product_version']); ?></a></td>
