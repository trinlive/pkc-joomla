...
if($_GET[actions]=="del"):
	...
	if($job):
			...
			$getdata[msg].="<meta http-equiv=\"refresh\" content=\"2; URL=testimonial_to_delete.php\">";	
			saverecord('Delete Testimonial');	
	else :
...
$SQLstr = 'SELECT * FROM `jobs` ORDER BY `jobs`.`job_id` DESC ';
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head05.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Delete Jobs </span></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="8">&nbsp;</td>
            <td bgcolor="#FFFFFF"><form action="jobs_action.php" method="post" name="form1" id="form1" style="margin:0" onSubmit="return checkForm();">
              <?php if (!$rs->EOF):?>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0" bordercolor="#FFFFFF" align="center">
  ...
  <tr>
    <td width="30" align="center" valign="top" class="text_gray_normal"><input type="checkbox" name="chkbox[<?php echo $rs->fields['tid']?>]" id="chkbox" value="<?php echo $rs->fields['job_id']?>" onClick="swapCheckBox();"></td>
    <td width="60" align="center" class="text_gray_normal"><a  href="job_edit.php?job_id=<?php echo $rs->fields['job_id'] ?>" class="text_gray_normal"><?php echo $rs->fields['job_id'] ?></a></td>
    <td><span class="text_violet_normal"><?php echo stripslashes($rs->fields['job_position'])?></span></td>
    <td width="80" align="center" class="arialGREY11nor"><?php if ($rs->fields['job_status'] == 'Active'):
				echo '<b><font color="#0000FF">SHOW</font></b>';
				else:
				echo '<b><font color="#FF0000">HIDE</font></b>';
				endif; ?></td>
    <td width="35" class="text_gray_normal" align="center"><a href="?actions=del&job_id=<?php echo $rs->fields['job_id'] ?>&page=<?php echo $page ?>" ><img src="images/del_button.gif" width="13" height="13" border="0"></a></td>
  </tr>
</table>
<?php $rs->MoveNext(); ?>
<?php endwhile; ?>
