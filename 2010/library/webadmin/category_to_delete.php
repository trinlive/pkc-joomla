    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head05.gif">
          <tr>
            <td width="185" height="29"><span class="arialWH18B" style="margin-left:8px;">Delete Category</span></td>
            <td align="right">&nbsp; &nbsp; </td>
            <td width="214">&nbsp; &nbsp;</td>
          </tr>
        </table></td>
      ...
      <tr>
        <td><form name="form1" method="post" action="category_action.php" onSubmit="return checkForm();">
          ...
          <tr valign="top">
            ...
            <td><?php if (!$rs->EOF):?>
              <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                ...
                <tr>
                  <td width="30" align="center"><input type="checkbox" name="chkbox[<?php echo $rs->fields['cate_id'] ?>]" id="chkbox" value="<?php echo $rs->fields['cate_id'] ?>" onClick="swapCheckBox();"></td>
                  <td width="60" height="20" align="center" class="text_gray_normal"><a href="category_edit.php?cate_id=<?php echo $rs->fields['cate_id'] ?>"class="text_gray_normal"><?php echo $rs->fields['cate_id'] ?></a></td>
                  <td><span class="text_gray_normal"><a href="category_edit.php?cate_id=<?php echo $rs->fields['cate_id'] ?>" class="text_violet_normal"><?php echo stripslashes($rs->fields['cate_name'])?></a></span></td>
				...
				echo '<b><font color="#FF0000">HIDE</font></b>';
                  ...
                  <td width="35" align="center"><a href="?actions=del&amp;cate_id=<?php echo $rs->fields['cate_id'] ?>&amp;fileatt=<?php echo $rs->fields['fileatt']?>" onClick="return  confirm('Do you want to delete? ');"><img src="images/del_button.gif" width="13" height="13" border="0" /></a></td>
                </tr>
                <?php $rs->MoveNext(); ?>
                <?php endwhile; ?>
                <tr>
