                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            ...
                            <tr>
                              <td width="60" align="center" class="text_gray_normal"><a  href="download_edit.php?press_id=<?php echo $rs->fields['press_id'] ?>" class="text_gray_normal"><?php echo $rs->fields['press_id'] ?></a></td>
                              <td class="text_gray_normal"><a href="download_edit.php?press_id=<?php echo $rs->fields['press_id'] ?>" class="text_violet_normal"><?php echo $rs->fields['topic'] ?></a></td>
