    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="172" height="29"><span class="arialWH18B" style="margin-left:8px;">Send Mailing List </span></td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td><table width="99%" border="0" cellspacing="2" cellpadding="0" align="center">
              ...
              <tr>
                <td width="60" align="center" valign="top" class="text_gray_normal"><a  href="letter_to_send4.php?news_id=<?php echo $rs->fields['news_id'] ?>" class="text_gray_normal">
              <?php echo $rs->fields['news_id'] ?>
              </a></td>
                <td valign="top" class="text_gray_normal"><a  href="letter_to_send4.php?news_id=<?php echo $rs->fields['news_id'] ?>" class="text_gray_normal">
              <?php echo $rs->fields['subject'] ?>
              </a></td>
                <td width="80" align="center" class="text_gray_normal"><?php if ($rs->fields['news_active'] == 'Active'):
