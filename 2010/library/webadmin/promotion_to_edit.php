    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="180" height="29"><span class="arialWH18B" style="margin-left:8px;">Edit Promotion</span></td>
            <td width="255" align="right" class="text_violet_bold">&nbsp; &nbsp; </td>
            <td width="153">&nbsp; &nbsp;</td>
          </tr>
        </table></td>
      </tr>
                  ...
                  <?php  while (!$rs->EOF): ?>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            <tr>
                              <td colspan="4" align="center" class="text_gray_normal"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#def8f8">
                                  <tr>
                                    <td></td>
                                  </tr>
                              </table></td>
                            ...
                            <tr>
                              <td width="60" align="center" class="text_gray_normal"><a  href="promotion_edit.php?pid=<?php echo $rs->fields['promotion_id'] ?>" class="text_gray_normal"><?php echo $rs->fields['promotion_id'] ?></a></td>
                              <td class="text_gray_normal"><a href="promotion_edit.php?pid=<?php echo $rs->fields['promotion_id'] ?>" class="text_violet_normal"><?php echo $rs->fields['topic'] ?></a></td>
                              <td width="140" align="center" class="text_gray_normal"><?php 
							  switch($rs->fields['promotion_type']):
							  	case'south':
									echo "อาคเนย์ประกันชีวิต";
								break;
								case'seic':
									echo "อาคเนย์ประกันภัย";
								break;
								case'secap':
									echo "อาคเนย์แคปปิตอล";
								break;
							endswitch;	
							   ?></td>
