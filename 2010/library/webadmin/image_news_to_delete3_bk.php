        ...
        <td></td>
          ...
          <tr>
            <td width="60" align="center" valign="top" class="text_gray_normal"><input type="checkbox" name="chkbox[]" id="chkbox" value="<?php echo  $rs->fields['id'] ?>" onClick="swapCheckBox();" /></td>
              ...
              <td valign="top" class="text_gray_normal"><a href="image_news_edit.php?id=<?php echo $rs->fields['id'] ?>" class="text_gray_normal"><img src="../img_news/thumbnail/<?php echo $rs->fields['image1']?>" border="0"></a></td>
