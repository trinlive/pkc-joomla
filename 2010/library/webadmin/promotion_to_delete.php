...
<?php //ลบ
if($_GET['actions']=="del"){
	$gettmp['promotion_id'] = $_GET['promotion_id'];
	$gettmp['fileatt'] = $_GET['fileatt'];
	if ($gettmp[fileatt] != "") :
		if(file_exists("../img_promotion/$gettmp[fileatt]")) unlink("../img_promotion/$gettmp[fileatt]");
	endif ;
	...
	if($promotion):
		...
		///echo "<meta http-equiv=\"refresh\" content=\"0; URL=promotion_to_delete.php?page=".$_GET[page]."\">";
		//exit();
	endif ;		
} // ลบ
?>
...
$SQLstr = "SELECT * FROM promotions ORDER BY promotion_id DESC ";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="185" height="29"><span class="arialWH18B" style="margin-left:8px;">Delete Promotion </span></td>
            <td align="right">&nbsp; &nbsp; </td>
            <td width="214">&nbsp; &nbsp;</td>
          </tr>
        </table></td>
      ...
      <tr>
        <td><form name="form1" method="post" action="promotion_action.php" onSubmit="return checkForm();">
          ...
          <tr valign="top">
            ...
            <td><?php if (!$rs->EOF):?>
              <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                ...
                <?php  while (!$rs->EOF): ?>
                <tr>
                  <td height="1" colspan="6" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#def8f8">
                      <tr>
                        <td></td>
                      </tr>
                  </table></td>
                ...
                <tr>
                  <td width="30" align="center"><input type="checkbox" name="chkbox[<?php echo $rs->fields['promotion_id'] ?>]" id="chkbox" value="<?php echo $rs->fields['promotion_id'] ?>" onClick="swapCheckBox();"></td>
                  <td width="60" height="20" align="center" class="text_gray_normal"><a href="promotion_edit.php?product_id=<?php echo $rs->fields['promotion_id'] ?>"class="text_gray_normal"><?php echo $rs->fields['promotion_id'] ?></a></td>
                  <td><span class="text_gray_normal"><a href="promotion_edit.php?pid=<?php echo $rs->fields['promotion_id'] ?>" class="text_violet_normal"><?php echo stripslashes($rs->fields['topic'])?></a></span></td>
                  <td align="center"><span class="text_gray_normal">
                    <?php 
							  switch($rs->fields['promotion_type']):
							  	case'pronotion':
									echo "Promotion";
								break;
                  ...
                  <td width="80" align="center" class="arialGREY11nor"><?php if ($rs->fields['promotion_status'] == 'Active'):
				echo '<b><font color="#0000FF">SHOW</font></b>';
				else:
				echo '<b><font color="#FF0000">HIDE</font></b>';
				endif; ?></td>
                  <td width="35" align="center"><a href="?actions=del&promotion_id=<?php echo $rs->fields['promotion_id'] ?>&fileatt=<?php echo $rs->fields['image'] ?>&page=<?php echo CURRENT_PAGE?>" onClick="return  confirm('Do you want to delete? ');"><img src="images/del_button.gif" width="13" height="13" border="0" /></a></td>
                </tr>
                <?php $rs->MoveNext(); ?>
                <?php endwhile; ?>
                <tr>
                  <td colspan="7" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" bgcolor="#def8f8">
                      <tr>
                        <td></td>
                      </tr>
                  </table></td>
