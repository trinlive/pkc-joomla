    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Edit BOOk</span></td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            ...
                            <tr>
                              <td width="60" align="center" class="text_gray_normal"><a  href="book_edit.php?book_id=<?php echo $rs->fields['book_id'] ?>" class="text_gray_normal"><?php echo $rs->fields['book_id'] ?></a></td>
                              <td width="637" class="text_gray_normal"><a href="book_edit.php?book_id=<?php echo $rs->fields['book_id'] ?>" class="text_violet_normal"><?php echo $rs->fields['book_name'] ?></a></td>
