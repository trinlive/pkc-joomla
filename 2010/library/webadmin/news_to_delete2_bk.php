...
if($_GET[actions]=="del"):
	...
	if ($gettmp[pimage2] != "") :
		if(file_exists("../img_news/fullsize/$gettmp[pimage2]")) unlink("../img_news/fullsize/$gettmp[pimage2]");
					...
					$SQLstr3 = " SELECT * FROM news_files WHERE news_files.nid =  '".$gettmp[nid]."' ";
 				$rsdel3 = $db->Execute($SQLstr3) ;
					
					$fileatt = $rsdel3->fields['fileatt'] ;
						if ($pimage != "") :
	...
	while (!$rsdel2->EOF):
			...
			if ($pic_pimage != "") :
					if(file_exists("../img_sub_news/thumbnail/$pic_pimage")) unlink("../img_sub_news/thumbnail/$pic_pimage");
			endif ;	
			$pic_pimage2 = $rsdel2->fields['image2'] ;
			if ($pic_pimage2 != "") :
					if(file_exists("../img_sub_news/fullsize/$pic_pimage2")) unlink("../img_sub_news/fullsize/$pic_pimage2");
			endif ;	
