...
#$db->debug=1;
		$page_id = $_GET['page_id'] ; 
		 ...
		 $rs = $db->Execute($stmt,array($page_id)) ;
		 list($getyear, $getmonth, $getday,) = explode("-", $rs->fields['date_page']);
            ...
            <td><form action="keyword_action.php" method="post" enctype="multipart/form-data" name="form22" id="form22" style="margin:0" onSubmit=" return checkForm(); tinyMCE.triggerSave();">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><input name="url" type="text" class="border_bg_violet" id="url" style="width:70%" value="<?php echo $rs->fields['url'] ; ?>" /></td>
                </tr>
                <tr>
                  ...
                  <td><input name="topic" type="text" class="border_bg_violet" id="topic" style="width:70%" value="<?php echo $rs->fields['caption'] ; ?>" /></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="text_black_bold"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                    <tr>
                  ...
                  <td><textarea name="sdetail" class="border_bg_gray"  id="sdetail" style="width:70%"><?php echo $rs->fields['description'] ; ?></textarea></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="text_black_bold"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                    <tr>
                  ...
                  <td><textarea name="keyword" class="border_bg_gray"  id="keyword" style="width:70%"><?php echo $rs->fields['keyword']?></textarea></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="text_black_bold"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                    <tr>
         ...
         <tr>
                ...
                <tr>
                  ...
                  <td valign="top" class="text_black_bold"><select name="page_active" class="border_bg_violet" id="page_active">
                    <option value="Active" <?php if($rs->fields['page_active'] == "Active") : ?>selected<?php endif ; ?>>SHOW</option>
                    <option value="Inactive" <?php if($rs->fields['page_active'] == "Inactive") : ?>selected<?php endif ; ?>>HIDE</option>
                  </select></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="text_black_bold"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                ...
                <tr>
                  <td colspan="2" align="right" valign="top" class="text_black_bold"><p align="right">
					...
					<input type="hidden" name="page_id" value="<?php echo $rs->fields['page_id'] ; ?>" />
                  </p></td>
                </tr>
              </table>
              <p align="right">&nbsp;</p>
