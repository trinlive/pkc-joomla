...
<title>:: CONTROL PANEL - A.HA! WEB CREATION CO., LTD. ::</title>
              ...
              <tr>
                <td width="14%" valign="top"><?php if (!$rs->EOF):?>
                    <table width="100%" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="162" class="arialVIO11B">NEWS TYPE: </td>
                        <td class="arialVIO12B2"><?php if($news_type == "news") { echo "ข่าวรวม";} elseif($news_type == "news-cable") { echo "ข่าวเคเบิ้ลทีวี";}elseif($news_type == "news-security") { echo "กิจกรรมของ รปภ";}elseif($news_type == "news-home") { echo "ข่าวบ้านเอื้อาทร";}else { echo "ข่าวลงหนังสือพิมพ์" ;} ?></td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            ...
                            <tr>
                              <td width="60" align="center" class="text_gray_normal"><a  href="news_edit.php?nid=<?php echo $rs->fields['nid'] ?>" class="text_gray_normal"><?php echo $rs->fields['nid'] ?></a></td>
                              <td class="text_gray_normal"><a href="news_edit.php?nid=<?php echo $rs->fields['nid'] ?>" class="text_violet_normal"><?php echo $rs->fields['subject'] ?></a></td>
