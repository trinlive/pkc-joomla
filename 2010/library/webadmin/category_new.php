    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">CATEGORY</span></td>
          ...
          <tr valign="top">
            ...
            <td><form action="category_action.php" method="POST" enctype="multipart/form-data" name="form1" onSubmit="return checkForm();">
              <table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="162" valign="top" class="arialVIO11B">CATEGORY : </td>
                  <td valign="top" class="text_black_bold"><input name="cate_name" type="text" class="border_bg_violet" id="cate_name" style="width:70%"></td>
                </tr>
                <tr>
