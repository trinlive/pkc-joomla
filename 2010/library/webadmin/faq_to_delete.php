...
if($_GET[actions]=="del"){
	...
	$faq->load("faq_id=?", array($_GET['qid']));
	$faq->Delete();
			
	$faq_an->load("faq_id=?", array($_GET['qid']));
	$faq_an->Delete();
	saverecord('Delete FAQ');
	
	echo "<meta http-equiv=\"refresh\" content=\"0; URL=faq_to_delete.php?page=".$_GET[page]."\">";
} // จบการลบข้อมูล
?>
<?php
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Delete F.A.Q </span></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="8">&nbsp;</td>
            <td><form name="form" method="post" action="faq_question_action.php" style="margin:0;" onSubmit="return checkForm();">
<?php if (!$rs->EOF):?>
			...
			<?php  while (!$rs->EOF): 
					...
					$numrows=$rscount->RecordCount(); 
					 if ($numrows == 1) :
					 	$gettmp[popupmsg]="href='faq_answer_edit.php?qid=".$rs->fields['faq_id']."&page=".$page."' ";
					 else :
					 	$gettmp[popupmsg]="href='faq_answer_new.php?qid=".$rs->fields['faq_id']."&page=".$page."' onclick='return confirm(\"คำถามนี้ยังไม่มีคำตอบ คุณต้องการใส่คำตอบ ?\");' ";
					 endif ;
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            ...
                            <tr>
                              <td width="29" align="center" class="text_gray_normal"><input type="checkbox" name="chkbox[<?php echo $rs->fields['faq_id'] ?>]" id="chkbox" value="<?php echo $rs->fields['faq_id'] ?>" onClick="swapCheckBox();"></td>
				...
				echo '<b><font color="#0000FF">HIDE</font></b>';
                              ...
                              <td width="35" align="center" class="arialGREY11nor"><a href="?actions=del&qid=<?php echo $rs->fields['faq_id'] ?>&page=<?php echo $page ?>" onClick="return  confirm('Do you want to delete? ');"><img src="images/del_button.gif" width="13" height="13" border="0"></a></td>
                            </tr>
                        </table></td>
                      </tr>
                    </table>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100"><input type="image" src="images/but_del_selected.gif" align="middle"  name="Deleteall2" value="Delete Selected"></td>
                  ...
                  <td width="35" align="center" class="text_black12_bold"><?php echo $recordsFound ?></td>
                </tr>
              </table>
              <?php else: ?>
