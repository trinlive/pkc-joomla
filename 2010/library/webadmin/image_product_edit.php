...
`products`.`tid`,
`products`.`name_product` as newname_product,
`products`.`product_version` as newproduct_version
FROM
`products`
Inner Join `products_images` ON `products`.`tid` = `products_images`.`tid` where `products_images`.`id` = '$id' ";
$rs = $db->Execute($stmt) ;
?>
<html>
<head>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Edit Image Product </span></td>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top">
                  <form action="image_product_action.php" method="POST" enctype="multipart/form-data" name="form1" style="margin:0">
                      <table width="99%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="164" class="text_violet_bold03"><span class="arialVIO11B">PRODUCT NAME  :</span></td>
                          <td valign="top" class="arialVIO12B2"><?php echo $rs->fields['newname_product']?>&nbsp;&nbsp;<?php echo $rs->fields['newproduct_version']?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td valign="top" class="arialVIO11"><?php if($rs->fields['image2'] != "") :?><img src="../img_pro/fullsize/<?php echo $rs->fields['image2']?>" width="450" height="338" border="0">
              ...
              <td class="text_violet_normal03" ><input name="caption" type="text" class="border_bg_violet" id="caption" size="86" value="<?php echo stripslashes($rs->fields['caption'])?>">              </td>
                        ...
                        <tr>
                          <td colspan="2" align="right" valign="top" class="text_black_bold"><input name="MM_action" type="hidden" id="MM_action" value="update">
                            ...
                            <input name="tid" type="hidden" id="tid" value="<?php echo $rs->fields['tid'] ?>">
