    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">Add Images News </span></td>
      ...
      <tr>
        <td>
		<form action="image_action.php" method="POST" enctype="multipart/form-data" name="form1" style="margin:0" onSubmit="return checkForm();">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="8">&nbsp;</td>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#F7F7F7">
              <tr>
                <td width="164" class="arialVIO11B">CATEGORY  :</td>
                <td class="arialVIO12B2"> <?php echo stripslashes($rs->fields['news_type'])?> </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="arialVIO12B2"> <?php echo stripslashes($rs->fields['subject'])?> </td>
              </tr>
              <tr>
                <td colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="0" background="images/line_violet_double.gif">
                    <tr>
              ...
              <tr>
                <td colspan="2" align="right"><input name="nid" type="hidden" id="nid" value="<?php echo $_GET["nid"];?>">
