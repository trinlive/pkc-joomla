                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                            ...
                            <tr>
                              ...
                              <td class="text_gray_normal"><a href="faq_question_edit.php?qid=<?php echo $rs->fields['faq_id']  ; ?>&page=<?php echo $page?>" class="text_gray_normal"><?php echo cuttext(250,$rs->fields['question']) ?></a>&nbsp;&nbsp;<?php echo $gettmp[imgnew]?></td>
