    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="images/bg_head04.gif">
          <tr>
            <td width="176" height="29"><span class="arialWH18B" style="margin-left:8px;">View Resume </span></td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0" bordercolor="#FFFFFF" align="center">
  ...
  <tr>
     <td width="60" align="center" ><a  href="view_report_resume2.php?resume_id=<?php echo $rs->fields['resume_id'] ?>" class="text_gray_normal" target="_blank"><?php echo $rs->fields['resume_id'] ?></a></td>
	<td>
	  <?php 
	 ...
	 <a href="view_report_resume2.php?resume_id=<?php echo $rs->fields['resume_id'] ?>" target="_blank" class="text_violet_normal"><?php echo $rs->fields['job_title'] ?></a></td>
	<td width="170"><a href="view_report_resume2.php?resume_id=<?php echo $rs->fields['resume_id'] ?>" target="_blank" class="text_violet_normal"><?php echo $rs->fields['firstname'] ?>&nbsp;&nbsp;<?php echo $rs->fields['lastname'] ?></a></td>					  
	<td width="110" align="center"  class="text_violet_normal"><?php echo  date_edit3($rs->fields['postdate'],t) ?></td>			  
	<td width="35" align="center"  class="text_violet_normal"><?php echo $rs->fields['readed'] ?></td>
  </tr>
</table>
<?php $rs->MoveNext(); ?>
<?php endwhile; ?>
