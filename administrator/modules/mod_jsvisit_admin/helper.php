 ...
 * @version Version: 1.0.0 - 15-June-2023
...
class mod_jsvisit_adminHelper
{
    ...
    function getCountries ($num_countries, $minimum_percent, $params)
    {
        ...
        foreach ($rows as $row)
        {
            ...
            {
                $countries[$i]['name'] = str_replace(array(
                        '(',
                        ')'
                ), '', $row->name);
    ...
    function ckeck_key ($key)
    {
        if ($this->_lang == 'de')
        {
            if (file_exists(JPATH_ADMINISTRATOR . "/language/" . $this->_tag . "/" . $this->_tag . ".mod_jsvisit_admin.ini"))
            {
                $ini1_keys = parse_ini_file(JPATH_ADMINISTRATOR . "/language/" . $this->_tag . "/" . $this->_tag . ".mod_jsvisit_admin.ini", true);
        ...
        {
            $ini1_keys = parse_ini_file(JPATH_ADMINISTRATOR . "/language/pl-PL/pl-PL.mod_jsvisit_admin.ini", true);
