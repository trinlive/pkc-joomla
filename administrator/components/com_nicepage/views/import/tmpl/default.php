...
<script>
    jQuery(function($) {
        ...
        var importProductsChbx = $('input[id="importproducts"]');
        var updatePluginSettingsChbx = $('input[id="updatePluginSettings"]');
        var previousContentData = $('input[id*="idsData"]');

        var importProducts = importProductsChbx[0].checked ? '1' : '0';
        importProductsChbx.click(function() {
            importProducts = this.checked ? '1' : '0';
        });
        ...
        function ChunkedUploader(file, params) {
            ...
            function createChunk(data, params) {
                ...
                formData.append('importProducts', importProducts);
...
<div id="j-main-container" class="span10">
    <div class="import-container">
        ...
        <div class="import-group clearfix">
            <div class="import-control">
                <input type="checkbox" name="importproducts" id="importproducts">
            </div>
            <div class="import-label">
                <label for="checkbox-field"><?php echo Text::_('COM_NICEPAGE_IMPORT_IMPORT_PRODUCTS_LABEL'); ?></label>
            </div>
        </div>
        <div class="import-group clearfix">
            <div class="import-control">
