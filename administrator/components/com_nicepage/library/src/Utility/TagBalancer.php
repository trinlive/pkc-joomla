...
class TagBalancer {
    ...
    public static function process($text) {
        ...
        $text = preg_replace_callback('/<script[^>]*>([\s\S]*?)<\/script>/', self::class . '::beginScriptReplacer', $text);
        ...
        $output = preg_replace_callback('/\[\[BDSCRIPT[0-9]+\]\]/', self::class . '::endScriptReplacer', $output);
        return $output;
    }
}
