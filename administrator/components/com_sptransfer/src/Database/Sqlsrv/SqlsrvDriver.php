...
namespace Joomla\Component\Sptransfer\Administrator\Database\Sqlsrv;

/**
 * Description of SqlsrvDriver
 *
 * @author KAINOTOMO PH LTD <info@kainotomo.com>
 */
class SqlsrvDriver extends \Joomla\Database\Sqlsrv\SqlsrvDriver{
