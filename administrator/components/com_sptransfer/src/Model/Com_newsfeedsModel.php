...
class NewsfeedModel extends \Joomla\Component\Newsfeeds\Administrator\Model\NewsfeedModel
{
        ...
        public function getTable($name = '', $prefix = '', $options = array())
        {
                ...
                $table = new NewsfeedTable($this->_db);
 ...
 */
class Com_newsfeedsModel extends ComModel
{
        ...
        {
                $this->destination_model = new NewsfeedModel(array('dbo' => $this->destination_db));
                $this->source_model = new NewsfeedModel(array('dbo' => $this->source_db));
