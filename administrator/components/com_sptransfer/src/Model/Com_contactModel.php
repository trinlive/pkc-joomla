...
class ContactModel extends \Joomla\Component\Contact\Administrator\Model\ContactModel {
        ...
        public function getTable($name = '', $prefix = '', $options = array()) {
                ...
                $table = new ContactTable($this->_db);
 ...
 */
class Com_contactModel extends ComModel{
        ...
        public function contact_details($ids = null) {
                $this->destination_model = new ContactModel(array('dbo' => $this->destination_db));
                $this->source_model = new ContactModel(array('dbo' => $this->source_db));
