...
class PluginTag
{
     ...
     * @return array
     */
    public static function getDivTags(
        $start_tag = '',
        $end_tag = '',
        $tag_start = '{',
        $tag_end = '}'
     ...
     * @return string
     */
    public static function getRegexSurroundingTagsPost(
        $block_elements = [],
        $inline_elements = ['span'],
        $excluded_block_elements = []
    )
    {
     ...
     * @return string
     */
    public static function getRegexSurroundingTagsPre(
        $block_elements = [],
        $inline_elements = ['span'],
        $excluded_block_elements = []
    )
     ...
     * @return string
     */
    public static function getRegexTags(
        $tags,
     ...
     */
    public static function replaceKeyAliases(
        &$attributes,
        $key_aliases = [],
     ...
     */
    private static function getAttributeValueFromMatch(
        $match,
        $known_boolean_keys = [],
        $keep_escaped_chars = [','],
